...
async def handle_send_to_run_message(ws_state: Dict, data: Dict):
    ...
    async def prepare_payload(prompt: str) -> Dict[str, Any]:
        ...
        if resolution.text_segments:
            payload["text_segments"] = resolution.text_segments
        if resolution.aggregated_text:
            payload["aggregated_text"] = resolution.aggregated_text
